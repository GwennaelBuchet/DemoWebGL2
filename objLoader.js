///  CREDITS : https://github.com/sketchpunk/FunWithWebGL2/blob/master/lesson_011/ObjLoader.js
...
function parseObjText(txt, flipYUV) {
	...
	return {indices: fIndex, positions: fVert, normals: fNorm, texCoords: fUV};
}